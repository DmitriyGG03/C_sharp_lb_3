...
namespace C_sharp_lb_2
{
    public partial class CreationHostel : Form
    {
        ...
        private void ChangingPhotoTriggers(ref object sender, ref PictureBox photoBox, ref bool trigger, ref bool toCompare)
        {
            if (Campus.switchImageString(((TextBox)sender).Text))
            {
                if (toCompare) photoBox.ImageLocation = Campus.picOK;
                else photoBox.ImageLocation = Campus.picDislike;
                trigger = true;
            }
            else
            {
                photoBox.ImageLocation = Campus.picDislike;
                trigger = false;
            }
        }

        private void tb_name10_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_12, ref tr10_2, ref tr10_1);
        private void tb_surname10_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_12, ref tr10_1, ref tr10_2);

        private void tb_name9_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_11, ref tr9_2, ref tr9_1);
        private void tb_surname9_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_11, ref tr9_1, ref tr9_2);

        private void tb_name8_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_10, ref tr8_2, ref tr8_1);
        private void tb_surname8_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_10, ref tr8_1, ref tr8_2);

        private void tb_name7_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_9, ref tr7_2, ref tr7_1);
        private void tb_surname7_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_9, ref tr7_1, ref tr7_2);

        private void tb_name6_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_8, ref tr6_2, ref tr6_1);
        private void tb_surname6_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_8, ref tr6_1, ref tr6_2);

        private void tb_name5_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_7, ref tr5_2, ref tr5_1);
        private void tb_surname5_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_7, ref tr5_1, ref tr5_2);

        private void tb_name4_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_6, ref tr4_2, ref tr4_1);
        private void tb_surname4_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_6, ref tr4_1, ref tr4_2);   

        private void tb_name3_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_5, ref tr3_2, ref tr3_1);
        private void tb_surname3_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_5, ref tr3_1, ref tr3_2);

        private void tb_name2_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_4, ref tr2_2, ref tr2_1);
        private void tb_surname2_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_4, ref tr2_1, ref tr2_2);

        private void tb_name1_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_3, ref tr1_2, ref tr1_1);
        private void tb_surname1_TextChanged(object sender, EventArgs e) => ChangingPhotoTriggers(ref sender, ref pb_3, ref tr1_1, ref tr1_2);
